...
export default function Blogs({btnname}) {
    ...
    return (
        <div className=" mt-3 sm:mt-10">
            <div className=" w-[100%] sm:w-[40%] mx-auto text-center mb-10 sm:mb-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-10">
                {blogData.map((blog) => (
                    <div key={blog.id} className="border p-4 rounded-lg">
                        ...
                        <p className="mt-2 text-gray-600">{blog.content} <span className=' cursor-pointer textColor underline'>read more</span></p>
                    </div>
                ))}
            </div>
